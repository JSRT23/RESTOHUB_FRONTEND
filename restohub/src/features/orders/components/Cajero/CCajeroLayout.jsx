// src/features/orders/components/Cajero/CCajeroLayout.jsx
// Layout del cajero — 3 tabs: Cobrar · Pedidos del día · Mi turno
// Ruta base: /caja
...
const TABS = [
  { to: "/caja", label: "Cobrar", icon: Banknote, end: true },
  { to: "/caja/pedidos", label: "Pedidos del día", icon: ClipboardList },
  { to: "/caja/turno", label: "Mi turno", icon: Clock },
];

export default function CCajeroLayout() {
  return (
