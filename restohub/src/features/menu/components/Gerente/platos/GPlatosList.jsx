// src/features/gerente/menu/platos/GPlatosList.jsx
// Lista principal de platos del gerente.
// Toda la lógica pesada vive en CreatePlatoWizard y PlatoDetailModal.
    ...
    <div className="space-y-6">
      ...
      {!loading && platos.length > 0 && (
        <div className="flex items-center gap-3 flex-wrap">
          {[
            { n: platos.length, l: "en total", highlight: false },
            { n: activos, l: "activos", highlight: true },
            { n: platos.length - activos, l: "inactivos", highlight: false },
          ]
            .filter((s) => s.n > 0)
            .map((s, i) => (
              <div
                ...
                style={
                  s.highlight
                    ? { background: `${G[50]}99`, borderColor: G[100] }
                    : {}
                }
              >
                <span
                  ...
                  style={{
                    fontFamily: "'Playfair Display', serif",
                    color: s.highlight ? G[500] : "#1c1917",
                  }}
                >
                  {s.n}
                </span>
                <span
                  ...
                  style={{ color: s.highlight ? G[300] : "#9ca3af" }}
                >
                  {s.l}
                </span>
              </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
          ...
          {[
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-xs font-dm font-medium transition-all ${
                filtroActivo === v ? "" : "text-stone-400 hover:text-stone-700"
              }`}
            >
              {l}
            </button>
        ...
        <select
          ...
          className="px-3.5 py-2.5 rounded-xl bg-white border border-stone-200 text-sm font-dm text-stone-600 outline-none appearance-none shadow-sm transition-all"
          onFocus={(e) => {
            e.target.style.borderColor = "transparent";
            e.target.style.boxShadow = `0 0 0 2px ${G[300]}`;
          }}
